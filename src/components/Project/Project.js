...
export default function NewProject(props) {
   ...
   const infoStyle = {
      backgroundImage: `url("${
         props.image || "https://picsum.photos/800/500?grayscale"
      }")`,
      backgroundSize: "100%",
   };
   ...
   const tools = props.madeWith
      ? props.madeWith.map((t) => {
      ...
      <div className={"Project"}>
         ...
         {props.github || props.demo || props.more ? (
            <div id={"links"}>
               ...
               {props.demo ? (
                  <a id={"demo"} href={props.demo} target={"_blank"}>
                     <div>
                        <pre>Demo </pre>
